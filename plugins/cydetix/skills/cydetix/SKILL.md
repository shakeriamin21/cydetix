...
the pinned CLI. For assessment run `npx --yes cydetix@0.6.0-alpha.2 --json`. For a remediation plan,
run `npx --yes cydetix@0.6.0-alpha.2 fix --dry-run --format json`. Only after explicit fix intent
may the host run `npx --yes cydetix@0.6.0-alpha.2 fix --non-interactive --format json`. Run commands

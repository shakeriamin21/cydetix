...
export async function inspectPassiveGitMetadata(root: string): Promise<PassiveGitMetadata> {
  ...
  return {
    ...
    workingTreeState: "UNKNOWN",
    limitation:
      "Working-tree cleanliness is UNKNOWN because Cydetix does not execute Git or repository-configured fsmonitor hooks during static analysis.",
  };
}

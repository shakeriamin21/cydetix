...
import { configSchema, type CydetixConfig } from "../core/schema.js";
import { CydetixError, EXIT } from "../core/errors.js";
import type { RepositoryBoundary } from "./boundary.js";

export const CONFIG_NAME = ".cydetix.json";
...
export const DEFAULT_CONFIG: CydetixConfig = configSchema.parse({
  schemaVersion: "1.0.0",
});

export async function loadConfig(boundary: RepositoryBoundary): Promise<CydetixConfig> {
  const candidates = [CONFIG_NAME];

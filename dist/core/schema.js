...
import { authorizationProofSchema, evidencePathStepSchema, } from "../authorization-analysis/model.js";
import { authenticationAnalysisSchema, authenticationStandardMappingSchema, } from "../authentication-analysis/model.js";
...
export const ruleDefinitionSchema = z
    ...
    supportedSourcePatterns: z.array(z.string().min(1)).min(1).optional(),
    supportedSinkPatterns: z.array(z.string().min(1)).min(1).optional(),
    controlSemantics: z.array(z.string().min(1)).min(1).optional(),
    boundedPropagationModel: z.string().min(1).optional(),
    confidenceModel: z.string().min(1).optional(),
    proofRequirements: z.array(z.string().min(1)).min(1).optional(),

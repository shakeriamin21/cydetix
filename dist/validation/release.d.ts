import { z } from "zod";
export declare const legacyReleaseValidationSchemaVersion: "1.2.0";
export declare const releaseValidationSchemaVersion: "1.3.0";
...
export declare const currentReleaseValidationVerdictSchema: z.ZodEnum<{
    NOT_READY_FOR_PUBLIC_USE: "NOT_READY_FOR_PUBLIC_USE";
    PUBLIC_ALPHA_READY_WITH_LIMITATIONS: "PUBLIC_ALPHA_READY_WITH_LIMITATIONS";
    PUBLIC_BETA_READY_WITH_LIMITATIONS: "PUBLIC_BETA_READY_WITH_LIMITATIONS";
    PUBLIC_STABLE_READY_WITH_LIMITATIONS: "PUBLIC_STABLE_READY_WITH_LIMITATIONS";
}>;
export type CurrentReleaseValidationVerdict = z.infer<typeof currentReleaseValidationVerdictSchema>;
export declare function releaseValidationVerdictForVersion(version: string, ready: boolean): CurrentReleaseValidationVerdict;
export declare const legacyReleaseValidationReportSchema: z.ZodObject<{
    verdict: z.ZodEnum<{
        NOT_READY_FOR_PUBLIC_USE: "NOT_READY_FOR_PUBLIC_USE";
...
export declare const currentReleaseValidationReportSchema: z.ZodObject<{
    verdict: z.ZodEnum<{
        NOT_READY_FOR_PUBLIC_USE: "NOT_READY_FOR_PUBLIC_USE";
        PUBLIC_ALPHA_READY_WITH_LIMITATIONS: "PUBLIC_ALPHA_READY_WITH_LIMITATIONS";
        PUBLIC_BETA_READY_WITH_LIMITATIONS: "PUBLIC_BETA_READY_WITH_LIMITATIONS";
 ...
 */
export declare const releaseValidationReportSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
    verdict: z.ZodEnum<{
        NOT_READY_FOR_PUBLIC_USE: "NOT_READY_FOR_PUBLIC_USE";
        INTERNAL_ALPHA_READY: "INTERNAL_ALPHA_READY";
        PUBLIC_ALPHA_READY_WITH_LIMITATIONS: "PUBLIC_ALPHA_READY_WITH_LIMITATIONS";

...
export function validateCurrentReleaseReport(reportInput, packageIdentity, sourceIdentity) {
    ...
    const committedImmediatelyAfterSource = sourceCommit === sourceIdentity.parent &&

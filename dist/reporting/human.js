...
export function renderRemediationHuman(report) {
    ...
    lines.push(`SAFE: ${report.summary.safe}`, `REVIEW_REQUIRED: ${report.summary.reviewRequired}`, `ARCHITECTURAL: ${report.summary.architectural}`, `Residual findings: ${report.summary.residualFindings}`);

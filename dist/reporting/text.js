...
export function remediationExplanation(finding) {
...
export function renderFinding(finding) {
    ...
    const proofPath = finding.proof === undefined
        ? []
    ...
    return [
        ...
        ...(finding.proof === undefined
            ...
            : [
                ...
                ...proofPath
                    .slice(0, 16)
                    .map((step) => `    ${step.kind} ${terminalSafe(step.location.path)}:${step.location.line}: ${terminalSafe(step.label)}`),

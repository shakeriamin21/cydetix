...
export async function loadConfig(boundary) {
    ...
    if (selectedStat.isSymbolicLink() ||
        ...
        throw new CydetixError(`${selectedName} must be a regular file smaller than ${MAX_CONFIG_BYTES} bytes.`, EXIT.usage);
    }
    try {
        ...
        throw new CydetixError(`Invalid ${selectedName}; repository content was not echoed.`, EXIT.usage, {
            cause: error,
        });
    }
}

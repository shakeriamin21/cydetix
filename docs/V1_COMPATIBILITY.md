...
release. It does not declare the current `0.6.0-beta.4` development candidate to be a stable release
and does not expand security-analysis coverage or remediation authority.
